...
resource "aws_iam_policy" "ecs_execution_secrets" {
  name = "ecsExecutionAccessSecrets"
    ...
    Statement = [
      {
        ...
        Resource = [
          ...
          "arn:aws:secretsmanager:eu-central-1:288761758415:secret:social-network-secrets-*"
        ]
      }
    ]
  })
...
resource "aws_iam_role_policy_attachment" "ecs_execution_secrets_custom_attach" {
